...
// lib/DeploymentManager-cd5a9dbb.js
var require_DeploymentManager_cd5a9dbb = __commonJS({
  "lib/DeploymentManager-cd5a9dbb.js"(exports2) {
    "use strict";
...
require("os");
require("util");
var DeploymentManager = require_DeploymentManager_cd5a9dbb();
  ...
  switch (action) {
    case "create-release":
      return {
        ...
        artefact: (_b = Action__default["default"].getInput("artefact")) !== null && _b !== void 0 ? _b : process.cwd()
      };
