...
// lib/DeploymentManager-c1043858.js
var require_DeploymentManager_c1043858 = __commonJS({
  "lib/DeploymentManager-c1043858.js"(exports2) {
    "use strict";
...
`);
      ...
      async exec(script) {
        try {
          ...
          const {stdout, stderr} = await Util__namespace.promisify(CP__namespace.exec)(`${this.binSSH} -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -q -i ${quote(this.server.privateKey)} -p ${this.server.port} ${this.server.user}@${this.server.host} <<'${boundary}'
...
require("os");
require("util");
var DeploymentManager = require_DeploymentManager_c1043858();
