...
// lib/DeploymentManager-00a402e8.js
var require_DeploymentManager_00a402e8 = __commonJS({
  "lib/DeploymentManager-00a402e8.js"(exports2) {
    "use strict";
...
`);
      ...
      async exec(script) {
        try {
          ...
          const {stdout, stderr} = await Util__namespace.promisify(CP__namespace.exec)(`${this.binSSH} -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i ${quote(this.server.privateKey)} -p ${this.server.port} ${this.server.user}@${this.server.host} <<'${boundary}'
...
require("os");
require("util");
var DeploymentManager = require_DeploymentManager_00a402e8();
